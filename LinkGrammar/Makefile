...
${OBJ}/print-util.o ${OBJ}/link_test.o

${BIN}/link_test: ${OBJECTS}
		${CC} ${CLDFLAGS} ${OBJECTS} -o ${BIN}/link_test
...
${OBJ}/link_test.o: ${SRC}/link_test.c ${INCLUDES}
		${CC} ${CFLAGS} -I${INC} ${SRC}/link_test.c -o ${OBJ}/link_test.o
